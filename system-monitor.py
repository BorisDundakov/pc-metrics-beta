...
second_mem_card = page.add('mem_stats', ui.wide_series_stat_card(
    box='1 2 1 1',
    title='Second Memory',
    value='={{usage}}%',
    data=dict(usage=0.0),
...
while True:
    ...
    second_mem_usage = psutil.virtual_memory().percent
    second_mem_card.data.usage = mem_usage
    second_mem_card.plot_data[-1] = [tick, mem_usage]
